            ...
            __html: JSON.stringify({
              ...
              offers: [
                ...
                },
                {
                  ...
                  priceCurrency: 'RUB',
                  name: 'Старт',
                  description: 'Безлимитные ответы, профиль бизнеса, Deep Research, история',
                },
                {
                  '@type': 'Offer',
                  price: '1990',
                  priceCurrency: 'RUB',
                  name: 'Про',
                  description: 'До 5 профилей, 3 пользователя, хардкор, экспорт CSV',
                },
              ],
              inLanguage: 'ru',
            }),
