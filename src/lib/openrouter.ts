...
- Hardcore: стиль VIZIT/Aviasales — дерзко, смешно, вирусно. Абсурдные метафоры, неожиданные повороты. Цель — рассмешить. БЕЗ мата.` : ''}
${jsonFormat}`;
